...
**/
function parRunnerFactory(maxParProc) {
    ...
    **/
    function start(iterations) {
        ...
        .then(res => res.sort((a, b) => a.stats.avgTiming - b.stats.avgTiming))
    }
    ...
    function launchWorker(test) {
        return new Promise((resolve, reject) => {
            ...
            n.on('message', (m) => {
                if (m.event === 'testEnd') {
                    let data = new Result(m.data.key, m.data.v, m.data.s);
